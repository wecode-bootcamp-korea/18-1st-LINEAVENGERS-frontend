...
import "./RefundContainer.scss";

class RefundContainer extends Component {
  render() {
    return (
      <section className="refundContainer" ref={this.props.RefundContainer}>
        <h1>반품/교환정보</h1>
        <table>
          <tr>
            <th colSpan="4">
          ...
          <tr>
            <td rowSpan="2">반품/교환 사유에 따른 요청 가능 기간</td>
          ...
          <tr>
            ...
            <td colSpan="3">
              <ul>
                ...
                <li>
                  4. 구매자의 사용 또는 일부 소비에 의하여 상품의 가치가 현저히
                  감소한 경우
                </li>
                <li>
